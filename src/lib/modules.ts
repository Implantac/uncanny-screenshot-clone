import {
  ...
  KanbanSquare, Workflow, Ruler, ShoppingCart, Rocket, Star, Coins, Compass, UserCircle2, Route as RouteIcon, Database, ScrollText, Lock, ArrowLeftRight, Leaf, Repeat, Globe, ShieldAlert, Tag, Send, Flame, Activity, type LucideIcon,
} from "lucide-react";
...
export const MODULES: ModuleDef[] = [
  ...
  { slug: "materiais", path: "/materiais", title: "Biblioteca de Materiais", short: "Tecidos, aviamentos, cores", description: "Materiais reutilizáveis entre coleções (tecidos, aviamentos, paleta de cores).", icon: Database, group: "Desenvolvimento" },
  ...
  { slug: "fpa", path: "/fpa", title: "Planejamento Financeiro (FP&A)", short: "Forecast e plano x real", description: "Orçamento por coleção, forecast 12 meses e variação plano x real.", icon: Banknote, group: "Operação" },
  ...
  // === Plataforma ===
  { slug: "dpp", path: "/dpp", title: "Digital Product Passport", short: "Rastreabilidade", description: "Passaporte digital e compliance ESG.", icon: ShieldCheck, group: "Plataforma", hidden: true },
  ...
  { slug: "use-ai", path: "/use-ai", title: "USE AI", short: "Automação inteligente", description: "Agentes de IA para automação.", icon: Cpu, group: "Operação" },
