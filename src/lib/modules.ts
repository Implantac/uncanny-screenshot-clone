...
export const MODULES: ModuleDef[] = [
  ...
  { slug: "fpa", path: "/fpa", title: "Planejamento Financeiro (ERP)", short: "Pertence ao ERP", description: "FP&A e orçamento são do ERP — rota preservada para histórico.", icon: Banknote, group: "ERP (Integração)", source: "erp-mirror", hidden: true },
