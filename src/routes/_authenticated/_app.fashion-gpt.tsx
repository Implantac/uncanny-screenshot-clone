...
export const Route = createFileRoute("/_authenticated/_app/fashion-gpt")({
  head: () => ({
    meta: [
          ...
          {messages.length === 0 && (
            <div className="flex gap-3">
              ...
              <div className="glass rounded-2xl px-4 py-2.5 max-w-[80%] text-sm leading-relaxed">
                Olá! Sou o <strong>Fashion GPT</strong>, seu copiloto especialista em moda. Pergunte
                sobre coleções, margens, fornecedores, PCP ou qualquer área da operação.
              </div>
            </div>
          )}
          {messages.map((m) => {
            ...
            return (
              ...
              >
                <div
                  className={`size-8 rounded-full grid place-items-center shrink-0 ${m.role === "user" ? "bg-muted" : "bg-[image:var(--gradient-primary)] shadow-[var(--shadow-glow)]"}`}
                >
                  {m.role === "user" ? (
                ...
                <div
                  className={`rounded-2xl px-4 py-2.5 max-w-[80%] text-sm leading-relaxed ${m.role === "user" ? "bg-primary text-primary-foreground" : "glass"}`}
                >
                  {m.role === "user" ? (
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <button
              ...
              className="size-9 rounded-xl bg-[image:var(--gradient-primary)] text-primary-foreground grid place-items-center shadow-[var(--shadow-glow)] disabled:opacity-40 disabled:shadow-none transition-opacity"
            >
