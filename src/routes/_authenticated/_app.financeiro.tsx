    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="glass rounded-xl p-5">
          ...
          <div className="text-2xl font-semibold mt-1 tabular-nums text-emerald-400">
            {brl(totals.receber)}
          </div>
        </div>
        <div className="glass rounded-xl p-5">
        ...
        <div className="glass rounded-xl p-5">
          ...
          <div
            className={`text-2xl font-semibold mt-1 tabular-nums ${totals.saldo >= 0 ? "text-emerald-400" : "text-destructive"}`}
          >
            {brl(totals.saldo)}
          </div>
        </div>
                  ...
                  return (
                    <tr key={r.id} className="border-t border-border hover:bg-muted/30">
                      <td className="px-5 py-3">
                        <span
                          className={`px-2 py-0.5 rounded text-xs ${r.type === "receber" ? "bg-emerald-500/15 text-emerald-400" : "bg-sky-500/15 text-sky-400"}`}
                        >
                          ...
                          <div className="flex justify-end gap-1">
                            {r.status === "pendente" && (
                              <button
                                ...
                                className="size-7 grid place-items-center rounded hover:bg-emerald-500/20 text-emerald-400"
                              >
                            ...
                            <button
                              onClick={() =>
                                confirm("Remover este lançamento?") && deleteMut.mutate(r.id)
                              }
